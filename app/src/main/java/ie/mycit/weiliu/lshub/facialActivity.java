...
import ie.mycit.weiliu.lshub.utils.MyHelper;

public class facialActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myTextView = findViewById(R.id.textView111);
        myImageView = findViewById(R.id.imageView111);
...
//Disable face tracking//
        ...
        detector.detectInImage(image).addOnSuccessListener(new OnSuccessListener<List<FirebaseVisionFace>>() {
            ...
            public void onFailure
                ...
                Toast.makeText(facialActivity.this,
